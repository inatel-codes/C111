...
previsao <- pagina1 %>% html_nodes(".forecast-text")
previsao
...
???
#Sim, pois o Multiple R-squared é ígual a 0.81 e assim mostra que o nível de precisão está relativamente alto, o que significa que o modelo errou menos. 
